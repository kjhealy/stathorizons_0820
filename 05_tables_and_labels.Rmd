...
**NOTE** We've used `coord_flip()` for illustrative purposes, and because it used to be required to get `geom_boxplot()` to work properly with categories on the y-axis. But this isn't true anymore. Just map the variables directly to the axes:
