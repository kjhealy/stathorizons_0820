...
4. Try adding a log scale to the x-axis.
5. Facet the plot by continent.
6. Subset the data so that you pick out the following four years: 1952, 1972, 1992, and 2002. Plot a histogram of life expectancy faceted by year. 
